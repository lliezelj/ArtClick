...
<body>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="me-3" data-bs-toggle="modal" data-bs-target="#announcement-edit">
    ...
    <div class="modal fade" id="announcement-edit" tabindex="-1" aria-labelledby="announcement-edit" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Add New Announcement</h5>
